...
public partial class
    ProductAttributeOptionToProductAttributeOptionDtoMapper : MapperBase<ProductAttributeOption,
...
public partial class
    CreateUpdateProductDetailDtoToProductDetailMapper : MapperBase<CreateUpdateProductDetailDto, ProductDetail>
{
    public override partial ProductDetail Map(CreateUpdateProductDetailDto source);

    public override partial void Map(CreateUpdateProductDetailDto source, ProductDetail destination);
}

[Mapper(RequiredMappingStrategy = RequiredMappingStrategy.Source)]
public partial class
    CreateUpdateProductAttributeDtoToProductAttributeMapper : MapperBase<CreateUpdateProductAttributeDto,
    ProductAttribute>
{
...
[Mapper(RequiredMappingStrategy = RequiredMappingStrategy.Source)]
public partial class
    CreateUpdateProductAttributeOptionDtoToProductAttributeOptionMapper : MapperBase<
    CreateUpdateProductAttributeOptionDto,
    ProductAttributeOption>
{
    public override partial ProductAttributeOption Map(CreateUpdateProductAttributeOptionDto source);

    public override partial void Map(CreateUpdateProductAttributeOptionDto source, ProductAttributeOption destination);
}
...
[Mapper(RequiredMappingStrategy = RequiredMappingStrategy.Target)]
public partial class
    ProductDetailHistoryToProductDetailHistoryDtoMapper : MapperBase<ProductDetailHistory, ProductDetailHistoryDto>
{
