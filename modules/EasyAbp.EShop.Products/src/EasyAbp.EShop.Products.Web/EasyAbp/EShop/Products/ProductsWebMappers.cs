...
namespace EasyAbp.EShop.Products.Web.EasyAbp.EShop.Products;
...
public partial class ProductDtoToCreateEditProductViewModelMapper : MapperBase<ProductDto, CreateEditProductViewModel>
{
    ...
    [MapperIgnoreSource(nameof(ProductDto.Sold))]
    [MapperIgnoreSource(nameof(ProductDto.ProductDetailId))]
    ...
    {
        destination.ProductAttributeNames = source.ProductAttributes.Select(x => x.DisplayName).JoinAsString(",");
...
public partial class CreateEditProductViewModelToCreateUpdateProductDtoMapper : MapperBase<CreateEditProductViewModel, CreateUpdateProductDto>
{
    ...
    [MapperIgnoreSource(nameof(CreateEditProductViewModel.ProductDetail))]
            ...
            .Select((s, i) => new CreateUpdateProductAttributeDto
            {
                ...
                ProductAttributeOptions = new List<CreateUpdateProductAttributeOptionDto>(
                    source.ProductAttributeOptionNames.SplitToLines(StringSplitOptions.RemoveEmptyEntries)[i]
                        ...
                        .Select(o => new CreateUpdateProductAttributeOptionDto { DisplayName = o.RemovePostFix("\r") }))
            }).ToList();
    }
}
...
public partial class CreateProductSkuViewModelToCreateProductSkuDtoMapper : MapperBase<CreateProductSkuViewModel, CreateProductSkuDto>
{
    ...
    [MapperIgnoreSource(nameof(CreateProductSkuViewModel.ProductDetail))]
    [MapperIgnoreSource(nameof(CreateProductSkuViewModel.Inventory))]
...
public partial class EditProductSkuViewModelToUpdateProductSkuDtoMapper : MapperBase<EditProductSkuViewModel, UpdateProductSkuDto>
{
    ...
    [MapperIgnoreSource(nameof(EditProductSkuViewModel.ProductDetail))]
...
public partial class ProductSkuDtoToEditProductSkuViewModelMapper : MapperBase<ProductSkuDto, EditProductSkuViewModel>
{
    ...
    [MapperIgnoreSource(nameof(ProductSkuDto.AttributeOptionIds))]
    [MapperIgnoreSource(nameof(ProductSkuDto.Inventory))]
    [MapperIgnoreSource(nameof(ProductSkuDto.Sold))]
